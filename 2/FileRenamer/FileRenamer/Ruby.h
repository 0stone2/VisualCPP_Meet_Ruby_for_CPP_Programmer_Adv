...
#pragma comment(lib, "C:/Script/Ruby/lib/libmsvcrt-ruby230.lib")
...
extern "C" {
	...
	__declspec(dllimport) VALUE rb_cObject;
	...
	VALUE	rb_ivar_set(VALUE, const char*, VALUE);
	VALUE	rb_ivar_get(VALUE, const char*);
	VALUE	rb_ary_new();
}
